...
function Library:_createInfoTab(WindowObject)
    ...
    local discordIconId = "rbxassetid://94434236999817"

    local infoTab = WindowObject:AddTab({ Name = "Info", Icon = "discord" })
    ...
    new("ImageLabel", {
        Parent = headerRow,
        Image = dc.Icon or discordIconId,
    ...
    local function applyStats(stats)
        ...
        if members ~= nil or online ~= nil then
            statsLabel.Text = formatRichText(string.format(
                "Members: %s  <font color=\"#52525B\">◆</font>  Online: <font color=\"#4ADE80\">%s</font>",
                membersText,
                onlineText
            ))
        else
